...
/**
 * Shared QuickPick item factories for the OpenCode Routes click menu.
 * Mirrors `WAT321_EPIC_HANDSHAKE/menuCommon.ts` so both tiers present
 * a consistent visual vocabulary: 🔵 BACK at the top of every
...
export function makePauseResumeItem(paused: boolean): Item {
  return paused
    ? {
        label: "🟢 RESUME",
        description: "Re-enable OpenCode Routes tool calls.",
