 ...
 * transcript tail. Used by the notification bridge to suppress
 * mid-tool-call notifications and by the auto-compact preflight
 * gate to refuse arming mid-turn. */
