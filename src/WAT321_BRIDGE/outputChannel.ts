 ...
 * loggers in WAT321_EPIC_HANDSHAKE and WAT321_MODEL_BRIDGE so the
 * three "WAT321: ..." entries in the Output panel dropdown feel
 * consistent. Hidden by default; surfaced manually when diagnosing
 * the unified MCP server's install / dispatch behavior.
 */
